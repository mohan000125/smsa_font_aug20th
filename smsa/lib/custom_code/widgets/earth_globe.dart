...
class EarthGlobe extends StatefulWidget {
  const EarthGlobe(
      {super.key, this.width, this.height, required this.globeData});

  final double? width;
  final double? height;

  final List<dynamic> globeData;
...
class _EarthGlobeState extends State<EarthGlobe> {
  ...
  void _loadPoints() {
    _points = widget.globeData.map((entry) {
  ...
  void _initController(ImageProvider surfaceImage) {
    ...
    _controller.onLoaded = () {
      ...
      // ✅ Center on India after loading the globe
