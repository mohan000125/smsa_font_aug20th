...
class ListClientWidget extends StatefulWidget {
  ...
  static String routeName = 'List-Client';
  static String routePath = '/listClient';

  @override
  State<ListClientWidget> createState() => _ListClientWidgetState();
}
...
class _ListClientWidgetState extends State<ListClientWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.clientAllData = await ClientMasterGroup.mAsterDataCall.call();

      if ((_model.clientAllData?.succeeded ?? true)) {
        _model.clientData = (getJsonField(
          (_model.clientAllData?.jsonBody ?? ''),
          r'''$''',
          true,
        )!
                .toList()
        ...
        await showDialog(
          ...
          builder: (alertDialogContext) {
            return AlertDialog(
              title: Text('Alert'),
              content: Text((_model.clientAllData?.exceptionMessage ?? '')),
              actions: [
                TextButton(
