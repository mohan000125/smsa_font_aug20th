...
class RecipientTempDataModelStruct extends BaseStruct {
  ...
  static RecipientTempDataModelStruct fromMap(Map<String, dynamic> data) =>
      RecipientTempDataModelStruct(
  ...
  static RecipientTempDataModelStruct? maybeFromMap(dynamic data) => data is Map
      ? RecipientTempDataModelStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static RecipientTempDataModelStruct fromSerializableMap(
  ...
  @override
  String toString() => 'RecipientTempDataModelStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is RecipientTempDataModelStruct &&
...
RecipientTempDataModelStruct createRecipientTempDataModelStruct({
  int? smsaRamId,
  String? recEmpId,
  String? recEmailId,
  String? recEmpName,
