...
class ThresholdMasterDataModelStruct extends BaseStruct {
  ...
  static ThresholdMasterDataModelStruct fromMap(Map<String, dynamic> data) =>
      ThresholdMasterDataModelStruct(
  ...
  static ThresholdMasterDataModelStruct? maybeFromMap(dynamic data) =>
      data is Map
          ? ThresholdMasterDataModelStruct.fromMap(data.cast<String, dynamic>())
          : null;
  ...
  static ThresholdMasterDataModelStruct fromSerializableMap(
  ...
  @override
  String toString() => 'ThresholdMasterDataModelStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ThresholdMasterDataModelStruct &&
...
ThresholdMasterDataModelStruct createThresholdMasterDataModelStruct({
  int? thresholdId,
  String? msgCurrency,
  String? senderBic,
  String? msgType,
