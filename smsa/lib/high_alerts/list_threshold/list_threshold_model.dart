...
import '/index.dart';
import 'list_threshold_widget.dart' show ListThresholdWidget;
...
class ListThresholdModel extends FlutterFlowModel<ListThresholdWidget> {
  ...
  // Stores action output result for [Backend Call - API (fetchThresholdMasterData)] action in List-Threshold widget.
  ApiCallResponse? thresholdMasters;
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<ThresholdMasterDataModelStruct>();
