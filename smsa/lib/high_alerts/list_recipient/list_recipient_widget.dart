...
import 'list_recipient_model.dart';
export 'list_recipient_model.dart';

class ListRecipientWidget extends StatefulWidget {
  const ListRecipientWidget({super.key});

  static String routeName = 'List-Recipient';
  static String routePath = '/listRecipient';

  @override
  State<ListRecipientWidget> createState() => _ListRecipientWidgetState();
}

class _ListRecipientWidgetState extends State<ListRecipientWidget>
    with TickerProviderStateMixin {
  late ListRecipientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListRecipientModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.recipientMasters =
          await RecipientApisGroup.fetchRecepientMasterDataCall.call();

      if ((_model.recipientMasters?.succeeded ?? true)) {
        _model.thresholdMasterData = (getJsonField(
          (_model.recipientMasters?.jsonBody ?? ''),
          r'''$''',
          true,
        )!
                .toList()
          ...
          builder: (alertDialogContext) {
            return AlertDialog(
              ...
              content: Text(valueOrDefault<String>(
                (_model.recipientMasters?.exceptionMessage ?? ''),
